...
export default function Footer() {
  ...
  return (
    <footer className="relative border-t border-zinc-900 mt-32">
      {/* Background gradient */}
      <GradientBlob
        className="bottom-0 left-1/2 -translate-x-1/2 w-250 h-100"
        colors="from-purple-500/10 via-indigo-500/10 to-transparent"
        blur="blur-3xl"
      />
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-16">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-zinc-500 leading-relaxed mb-6">
              AI image generation without complexity.
            </p>
            <div className="flex gap-4">
              {socialLinks.map((social) => (
                <a
                  key={social.name}
                  href={social.href}
                  className="text-zinc-600 hover:text-orange-400 transition-colors duration-200"
        ...
        <div className="pt-8 border-t border-zinc-900">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-zinc-600">
              © 2026 Alterra. All rights reserved.
            </p>
