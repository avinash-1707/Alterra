        ...
        <GlassCard glow>
          <div className="p-8">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-white text-black rounded-full font-medium hover:bg-zinc-100 transition-all duration-300 mb-6"
            >
